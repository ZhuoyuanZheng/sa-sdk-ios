Pod::Spec.new do |s|
  s.name         = "AppSightsAnalyticsSDK"
  s.version      = "1.10.24a"
  s.summary      = "The 3th party iOS SDK of Sensors Analytics."
  s.homepage     = "http://www.websights.cn"
  s.source       = { :git => 'https://github.com/ZhuoyuanZheng/sa-sdk-ios.git', :tag => "v#{s.version}" } 
  s.license = { :type => "Apache License, Version 2.0" }
  s.author = { "Zhuoyuan Zheng" => "littleb21@163.com" }
  s.platform = :ios, "7.0"
  ...
  s.subspec 'LOG' do |f|
        f.dependency 'AppSightsAnalyticsSDK/core'
